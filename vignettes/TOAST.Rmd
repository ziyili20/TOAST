...
cell types.  
For these data, traditional analysis methods that ignores
the cell mixture 
...
## Detect cell type-specific differential signals from the basic two group-designed experiment {#section:csDEbasic}
...
### Testing parameter effect (e.g. disease) in one cell type.
...
### Testing parameter effect in all cell types.
...
## Detect cell type-specific differential signals from the general experimental design
...
### Testing the effect of single parameter in one cell type.
